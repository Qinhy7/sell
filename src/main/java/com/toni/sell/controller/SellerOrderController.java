...
/**
 * @author ：qinhy
 * @date ：Created in 2019/3/18 0018 14:50
 * @modified By：
 */
@Controller
...
public class SellerOrderController {
    ...
    public ModelAndView list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<OrderMasterDTO> orderDTOPage = orderService.getAll(request);
    ...
    public ModelAndView cancel(@RequestParam("orderId") String orderId,
        ...
        map.put("msg", ExceptionCodeEnums.ORDER_CANCEL_SUCCESS.getMsg());
        map.put("url", "/sell/seller/order/list");
    ...
    public ModelAndView finished(@RequestParam("orderId") String orderId,
        ...
        map.put("msg", ExceptionCodeEnums.ORDER_FINISH_SUCCESS.getMsg());
        map.put("url", "/sell/seller/order/list");
        return new ModelAndView("common/success");
    }
